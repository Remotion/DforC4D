...
static assert(BaseDocument.sizeof == 1); 
//=============================================================================
struct BaseDocument //: public BaseList2D
{
	BaseList2D parent; //?
	alias parent this; //? 
private:
	@disable this();//BaseDocument();
	//~BaseDocument();

public:
	BaseDocument* GetNext() { return cast(BaseDocument*)C4DOS.At.GetNext(cast(GeListNode*)&this ); }
	BaseDocument* GetPred() { return cast(BaseDocument*)C4DOS.At.GetPred(cast(GeListNode*)&this ); }
	...
	Bool DoRedo();
	void FlushUndoBuffer() { C4DOS.Bd->FlushUndoBuffer(this); }
	...
	void Record() { C4DOS.Bd->Record(this); }
	...
	+/
	BaseDraw* GetRenderBaseDraw(){  return C4DOS.Bd.GetRenderBaseDraw(&this); }
	/+
	...
	// only internal!!!
	void RecordZero() { C4DOS.Bd->RecordZero(this); }
	void RecordNoEvent() { C4DOS.Bd->RecordNoEvent(this); }
